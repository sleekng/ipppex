    ...
    <div class="container mx-auto md:px-24">
        <div class=" md:flex md:justify-between md:items-center">
            <div class=" flex justify-between relative z-50 items-center px-4">
                <img class="logo" src="storage/img/logo-header-white.png" alt="">
                <div id="navbarToggle" class="md:hidden cursor-pointer  .toggle-nav flex justify-center items-center">
                    <i id="toggleIcon" class="fa-sharp  text-secondarycolor text-4xl fa-light fa-bars"></i>
             
                </div>
            </div>
            <div id="navMenu" class=" navigate-mobile space-x-4  md:flex md:justify-between md:items-center items-center">
