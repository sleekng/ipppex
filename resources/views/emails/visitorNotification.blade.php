...
<head>
    ...
    <title>IPPPEX Visitor Registration Confirmation</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            <h2>Dear <span class="highlight">{{ $name }}</span>,</h2>
            
            <p>Thank you for registering to attend IPPPEX 2024! We're excited to welcome you to this premier industry event.</p>
            ...
            <p>Your visitor registration has been successfully received and confirmed. Here's what you can expect:</p>
            
            <ul>
                <li>Access to all exhibition areas and stands</li>
                <li>Participation in seminars, conferences, and workshops</li>
                <li>Networking opportunities with industry professionals</li>
                <li>Exclusive deals and promotions from exhibitors</li>
                <li>Latest industry insights and technology demonstrations</li>
            </ul>

            <p>Please keep this registration ID handy for event check-in. We will send you additional information about:</p>
            
            <ul>
                <li>Event schedule and program details</li>
                <li>Venue information and directions</li>
                <li>Check-in procedures</li>
                <li>Special events and networking sessions</li>
            </ul>
            ...
            <p>We look forward to seeing you at IPPPEX 2024!</p>
        </div>
