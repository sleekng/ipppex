<x-app-layout>
    ...
    <div class="py-4">
        <div class=" mx-auto  lg:px-8">
            ...
            <div class=" flex space-x-2 items-center">
                <span class=" font-bold md:text-xl whitespace-nowrap">Total Exhibitors</span>
                <span
            ...
            <form action="{{ route('search-exhibitor') }}" method="POST"
                ...
                <x-input-search class=" w-full md:w-[400px] rounded-full " name="query" for="search"
                    placeholder="Search for Exhibitor" value="">
                    <x-slot name="icon">
    ...
    @foreach ($applicants as $applicant)
        <div id="modal{{ $applicant->id }}" class="modal modal__bg " role="dialog" aria-hidden="true">
            ...
            <div class="modal__dialog   lg:min-w-[748px] lg:p-5 px-4 w-full  ">
                    ...
                    <div class="md:px-8 w-full ">
                        ...
                        <div class="md:min-h-[60vh]   p-4 w-full white">
                            ...
                            <form action="{{ route('exhibitors.destroy', $applicant->id) }}" method="POST">
                                ...
                                <div class="mt-4 w-full">
                                    <x-input value="{{ $applicant->q_about }}"
                                        class=" w-full bg-transparent bg-gray-200" disabled name="q_about"
                                        for="q_about" placeholder="Enter your company role or position"
